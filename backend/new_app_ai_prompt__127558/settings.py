"""
Django settings for new_app_ai_prompt__127558 project.
...
ROOT_URLCONF = 'new_app_ai_prompt__127558.urls'
...
WSGI_APPLICATION = 'new_app_ai_prompt__127558.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "new_app_ai_prompt__127558 API",
    "DESCRIPTION": "API documentation for new_app_ai_prompt__127558 App",
    "VERSION": "v1",
}
