...
## Project Structure
    ...
    ├── new_app_ai_prompt__127558  # Django project configurations
...
1. Clone this repo and `cd new_app_ai_prompt__127558`
...
2. Clone this repo and `cd new_app_ai_prompt__127558`
